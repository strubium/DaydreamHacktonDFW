...
REM Copy project files to build folder (exclude build/dist folders)
echo Copying project files...
robocopy . %BUILD_DIR% /E /XD %BUILD_DIR% %DIST_DIR%
...
REM Copy app files to dist
echo Copying app files to dist...
robocopy %BUILD_DIR% %DIST_DIR% /E
